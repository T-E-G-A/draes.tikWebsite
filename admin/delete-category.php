...
<?php
    ...
    if(isset($_GET['id']) AND isset($_GET['image_name']))
    {
        ...
        <form method='POST' action='" . $_SERVER['PHP_SELF'] . "?id=$id&image_name=$image_name'>
            ...
            <input type='submit' href='" . SITEURL . "admin/manage-category.php' value='No'style='background-color:#ff4757;'>
        </form>";
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            if (isset($_POST['confirm']) && $_POST['confirm'] == 'Yes') {
                ...
                if($res == TRUE)
                {
                    ...
                    $_SESSION['delete'] = "<div class='danger'>Category has been deleted</div>";
                    // Redirect to manage category page
                    header('location:' . SITEURL . 'admin/manage-category.php');
                }
                else
                ...
                // Redirect to manage category page if Cancel is clicked
                header('location:' . SITEURL . 'admin/manage-category.php');
            }
        }
    }
